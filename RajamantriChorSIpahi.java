public class rajaMantri extends Activity {
	...
	public void onBackPressed() {
		//overriding onbackpressed method of class Activity	                              
	}
	@Override
	protected void onPostResume() {
		//overriding onpostresume() method of class Activity
		super.onPostResume();
		//calling onpostresume() method of super class Activity
	}
	@Override
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		//overriding onKeyDown() method of class Activity
		AlertDialog dialog = new AlertDialog.Builder(this).create();
		dialog.setTitle("Exit game!");
		dialog.setMessage("Are you sure you want to exit the game?");
		//Asking user to end the game or not
		//exit button
	...
	public void onLowMemory() {
		//overriding onLowMemory() method of class Activity
		AlertDialog dialog = new AlertDialog.Builder(this).create();
	...
	//declaring variables for player's score
 		...
 		btnSignin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(player1_name.equals("")||player2_name.equals("")||player3_name.equals("")||player4_name.equals("")){
					//if any players name/s is null then ask the user to enter his name
	...
	//method for updating the score of players
